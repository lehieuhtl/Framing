...
expName = 'Framing_HieuLe'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/hieule/Desktop/Fall23/AdvTopCog/Framing/Framing_HieuLe_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Welcome to the Framing task!\n\nPress spacebar to continue.',
        font='Open Sans',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='During this task you will be presented with a series of text and questions. Be sure to read properly and thoroughly, answer as soon as you have an answer in mind. If the buttons are not registering be sure to press in the squares to choose your answer. \n\nPress spacebar to continue to the task.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text = visual.TextStim(win=win, name='text',
        text='',
        font='Open Sans',
        pos=(0, .25), height=0.04, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    text_2 = visual.TextStim(win=win, name='text_2',
        text='',
        font='Open Sans',
        pos=(0, .02), height=0.04, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-3.0);
    ...
    WelcomeComponents = [text_3, key_resp]
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    InstructionsComponents = [text_4, key_resp_2]
    ...
    for thisCondition in conditions:
        ...
        trials = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions(listName),
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('code.started', globalClock.getTime())
        ...
        for thisComponent in codeComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('code.stopped', globalClock.getTime())
